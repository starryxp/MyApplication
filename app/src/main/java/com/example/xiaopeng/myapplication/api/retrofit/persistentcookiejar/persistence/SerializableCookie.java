...
package com.example.xiaopeng.myapplication.api.retrofit.persistentcookiejar.persistence;
...
public class SerializableCookie implements Serializable {
    ...
    public String encode(Cookie cookie) {
        ...
        try {
            ...
            Logger.t(TAG).e(e, "IOException in encodeCookie");
            return null;
        } finally {
            if (objectOutputStream != null) {
                try {
                    ...
                    Logger.t(TAG).e(e, "Stream not closed in encodeCookie");
                }
            }
        }
    ...
    public Cookie decode(String encodedCookie) {
        ...
        try {
            ...
            Logger.t(TAG).e(e, "IOException in decodeCookie");
        } catch (ClassNotFoundException e) {
            Logger.t(TAG).e(e, "ClassNotFoundException in decodeCookie");
        } finally {
            if (objectInputStream != null) {
                try {
                    objectInputStream.close();
                } catch (IOException e) {
                    Logger.t(TAG).e(e, "Stream not closed in decodeCookie");
                }
            }
        }
        return cookie;
